...
public class Register {
    ...
    public static final Block IMBUING_STATION_BLOCK = new ImbuingStation(FabricBlockSettings.of(Material.STONE).strength(4.0F).sounds(BlockSoundGroup.STONE).nonOpaque());
